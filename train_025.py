...
class Trainer():
    ...
    def train(self): # training for all datasets
        ...
        print(self.epoch,":OUT2 0.25 full trained:",total_loss,pre_count,gt_count)
        ...
        if mse<self.best_mse:
            ...
            torch.save(self.student.state_dict(), "student_out2_025_full_best.pt")
...
PATH_model="student_out2_025_full.pt"
